...
import re , urllib.parse , urllib.request , http.cookiejar , base64 , binascii , rsa,os
...
def login_weibo(nick , pwd):
    ...
    text = getData('http://weibo.com/1772181265/home?wvr=5&lf=reg')
    fp = open('yeah.html' , 'w' , encoding = 'utf-8')
    fp.write(text)
    fp.close()
    ...
    for i,item in enumerate(items):
        ...
        if suffix=='.jpg' or suffix=='.png':
            print(item)
            urllib.request.urlretrieve(item,str(i)+suffix)
